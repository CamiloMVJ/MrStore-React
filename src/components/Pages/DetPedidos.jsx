          ...
          <div style={styles.container}>
            ...
            <div style={styles.header}>
              <h1 style={styles.title}>
                Detalles del Pedido #{orders.id_pedido}
              </h1>
                  ...
                  <div key={index} style={styles.productCard}>
                    ...
                    <div style={styles.productInfo}>
                      <h4 style={styles.productName}>
                        {item.detproductos.productos.nombre_producto}
                      </h4>
                      <p style={styles.productDescription}>
                        {item.detproductos.productos.descripcion ||
                          "Sin descripción"}
                      </p>
                      <div style={styles.productMeta}>
                        <span style={styles.productPrice}>
                          $
                          {item.detproductos.productos.precio_producto.toFixed(
                            2
                          )}
                        </span>
                        ...
                        <span style={styles.productSubtotal}>
                          Subtotal: $
                          {(
                            item.detproductos.productos.precio_producto *
                            item.cantidad
                          ).toFixed(2)}
                        </span>
                      </div>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={{ ...styles.summaryRow, ...styles.totalRow }}>
                ...
                <span style={styles.totalPrice}>
                  ${Number(orders.total.toFixed(2)) + envio.costo_envio}
                </span>
              </div>
            </div>
          </div>
